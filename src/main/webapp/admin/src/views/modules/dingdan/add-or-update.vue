<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品编号" prop="caipinbianhao">
          <el-input v-model="ruleForm.caipinbianhao" 
              placeholder="菜品编号" clearable  :readonly="ro.caipinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜品编号" prop="caipinbianhao">
              <el-input v-model="ruleForm.caipinbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品类别" prop="caipinleibie">
          <el-input v-model="ruleForm.caipinleibie" 
              placeholder="菜品类别" clearable  :readonly="ro.caipinleibie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="烹饪方法" prop="pengrenfangfa">
          <el-input v-model="ruleForm.pengrenfangfa" 
              placeholder="烹饪方法" clearable  :readonly="ro.pengrenfangfa"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="烹饪方法" prop="pengrenfangfa">
              <el-input v-model="ruleForm.pengrenfangfa" 
                placeholder="烹饪方法" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
