<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜品类别" prop="caipinleibie">
        ...
        <div v-else>
          <el-form-item class="input" label="菜品类别" prop="caipinleibie">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yuancailiao" label="原材料" prop="yuancailiao">
                    <span>{{ruleForm.yuancailiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="菜品特色" prop="caipintese">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiage!=''&&json.jiage){
              		this.ruleForm.jiage = json.jiage
		}
        } else {
	...
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../ssmkjm78/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
